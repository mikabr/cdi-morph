...
author: "Mika Braginsky (MIT), Virginia A. Marchman (Stanford), Michael C. Frank (Stanford)"
date: '</div><img src="images/mika.jpg" class="title-img"><img src="images/virginia.jpeg" class="title-img"><img src="images/mike.jpeg" class="title-img"><span style="float:right;"><img src="images/icis.png" class="title-img"></span></div>'
output:
...
vocab_age_title <- glue("Vocabulary or age?")
...
<div class="notes">
FAs you can see, stem only first increases and then decreases.
</div>
