...
write_feather(verb_item_data, "data/verb_item_data.feather")
```
...
```{r verb_summaries}
verb_item_data <- read_feather("data/verb_item_data.feather")
...
write_feather(morph_verb_data, "data/morph_verb_data.feather")
```

```{r morph_summaries}
morph_verb_data <- read_feather("data/morph_verb_data.feather")
...
fit_morph_model <- function(formula, training_data, testing_data, group) {
  print("fitting model...")
